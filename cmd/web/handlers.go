...
func (app *Config) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	...
	// Credentials are valid, so log user in
...
func (app *Config) SubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.Session.Put(r.Context(), "error", fmt.Sprintf("Unable get planId: %s", err))
...
func (app *Config) generateManual(u data.User, plan *data.Plan) *gofpdf.Fpdf {
	...
	// Simulation of generating complex pdf
